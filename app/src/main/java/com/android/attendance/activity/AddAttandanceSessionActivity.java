...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "IT","CE"};
	private String[] yearString = new String[] {"1Y","2Y","3Y","4Y"};
	private String[] subjectSEString = new String[] {"Maths","BWT"};
	private String[] subjectTEString = new String[] {"CS","OOP"};
	private String[] subjectBEString = new String[] {"DS","DAA"};

	private String[] subjectFinal = new String[] {"Maths","BWT","OOP","DSML","JAVA"};
